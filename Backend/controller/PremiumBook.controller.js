const model = require('../model/Premium.model')

const creatBook = async (req,res)=>{

    try{
        const {Bookname,author,description,image,SourceUrl,publishYear} = req.body
    
        const newBook = model.create({Bookname,author,description,image,SourceUrl,publishYear})
